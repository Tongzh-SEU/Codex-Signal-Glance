...
final class CodexAppServerQuotaProvider: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.wendy.codex-signal-glance.app-server")
